  ...
  return (
    <div className={styles.site}>
      ...
      <card className={styles.resultContainer}>
        <svg className={styles.resultRechenzentrenContainer} width='80%' viewBox="0 0 510 395" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className={styles.resultNetzwerkeContainer} width='80%' viewBox="0 0 510 395" fill="none" xmlns="http://www.w3.org/2000/svg">
